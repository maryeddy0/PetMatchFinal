...
<body
	style="margin: 70px; background-image: url(cat.jpg); background-size: cover; background-repeat: no-repeat;">
	...
	<div id="quest">
		<form action="/matchResults">
			...
			<input type="radio" name="space" value="inhouse" checked>In
			house<br> <input type="radio" name="space" value="bi">Backyard
			and in house<br> <br>
			
			<p>2. Based off of your last answer, how big is that space?</p>
			<input type="radio" name="size" value="small" checked>Small
			Space<br> <input type="radio" name="size" value="enough">Enough
			Space<br> <input type="radio" name="size" value="large">Large
			amount of Space<br> <br>
			
			<p>3. How do you want to interact with your pet?</p>
			<input type="radio" name="interact" value="explore" checked>Explore<br>
			<input type="radio" name="interact" value="play">Play and
			exercise<br> <input type="radio" name="interact" value="admire">Admire<br>
			<input type="radio" name="interact" value="cuddle">Cuddle<br>
			<br>
			
			<p>4. What is your ideal budget for a pet per month?</p>
			<input type="radio" name="cost" value="l50" checked>$50 or
			less<br> <input type="radio" name="cost" value="50100">$50-100<br>
			...
			<input type="radio" name="hours" value="l5" checked>Less than
			5 hrs<br> <input type="radio" name="hours" value="b58">5-8
			hrs<br> <input type="radio" name="hours" value="m8">More
			than 8 hrs<br> <br>
			
			<p>6. What size poop can you endure?</p>
			<input type="radio" name="mess" value="smallgift" checked>A
			small gift<br> <input type="radio" name="mess" value="mediocre">A
			mediocre gift<br> <input type="radio" name="mess"
				value="massive">A massive gift<br>
			<br>
			...
			<input type="radio" name="eat" value="nlikely" checked>Not
			likely<br> <input type="radio" name="eat" value="only">Only
			under extreme conditions<br> <input type="radio" name="eat"
				value="possibly">Very possibly<br> <br>
			...
			<input type="radio" name="dress" value="no">No<br> <br>
			<input type="submit" value="Submit" onsubmit="return validateForm()">
			<!-- The form is gone, accidently deleted it -->
		</form>
	</div>
</body>
</html>