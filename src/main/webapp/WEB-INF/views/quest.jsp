...
<body>
		...
		<form action="/matchResults">
			...
			<input type="radio" name="cost" value="50">$50<br> <input
				type="radio" name="cost" value="50-100">$50-100<br> <input
				type="radio" name="cost" value="100-200">$100-200<br /> <input
				type="radio" name="cost" value="200+">$200+<br>
			...
			<input type="radio" name="noise" value="loud">Loud<br> <input
				type="radio" name="noise" value="minimal">Minimal<br> 
